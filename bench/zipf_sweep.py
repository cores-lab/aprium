...
N_THREADS = 32
N_REPS = 10
ZIPF_ALPHAS = [round(i * 0.1, 1) for i in range(16)]
# ==============================================================================
...
def main():
    parser = argparse.ArgumentParser(description="Distributed Zipf Sweep")
    ...
    output_csv = os.path.join(args.out, "zipf_sweep.csv")
    ...
    for alpha in ZIPF_ALPHAS:
        ...
        print(f"\n==== Target Zipf Alpha: {alpha:.1f} (Size: {gib} GiB) ====")
